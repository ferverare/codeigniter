...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <form  style="width: 35%"role="form" id="form" name="form" action="<?=base_url()?>index.php/api/userGet" method="GET">
  ...
  <form  style="width: 35%" role="form" id="form" name="form" action="<?=base_url()?>index.php/api/productoGet" method="GET">
