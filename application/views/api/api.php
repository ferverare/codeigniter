...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  <h1>Agregar Usuarios con Metodo POST</h1>

  <form  style="width: 35%"role="form" id="form" name="form" action="<?=base_url()?>index.php/api/userPost" method="POST">
  ...
  <h1>Agregar Productos con Metodo POST</h1>
  ...
  <form  style="width: 35%" role="form" id="form" name="form" action="<?=base_url()?>index.php/api/productoPost" method="POST">
    ...
    <h1>Agregar Usuarios con Metodo GET</h1>

  <form  style="width: 35%"role="form" id="form" name="form" action="<?=base_url()?>index.php/api/userGet" method="POST">
  ...
  <h1>Agregar Productos con Metodo GET</h1>

  <form  style="width: 35%" role="form" id="form" name="form" action="<?=base_url()?>index.php/api/productoGet" method="POST">
